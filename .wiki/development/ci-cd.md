...
last_updated: "2026-08-30T11:58:08.418Z"
...
The repository uses the **OMP agent** (`omp`) with model `ollama-cloud/glm-5.3-flash` for triage, labelling, review, and issue fixing.
